...
pokemons.forEach(function (elem) {
	let newCard = document.createElement("div");
	newCard.className = "card";
	newCard.innerHTML = `
		<div class="card-title">${elem.name}</div>
		<div class="card-img">
			<img src="${elem.img}" alt="${elem.name}" />
		</div>
		<div class="card-type">${elem.type.join(', ')}</div>
		<div class="card-count">Candy count: ${elem.candy_count || "N/A"}</div>
		<div class="card-weight">${elem.weight}</div>
		<div class="card-weaknesses">${elem.weaknesses.join(', ')}</div>
	`;
...
function sortPokemons() {
	...
	sortedPokemons.forEach(function (elem) {
		...
		sortedCard.innerHTML = `
			...
			<div class="card-weaknesses">${elem.weaknesses.join(', ')}</div>
		`;
		cardParent.appendChild(sortedCard);
	});
}

sortInput.addEventListener('click', sortPokemons);
